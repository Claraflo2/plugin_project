...
('PROJECT_MANAGEMENT','project.adminFeature.ManageProject.name',1,'jsp/admin/plugins/project/ManageProjects.jsp','project.adminFeature.ManageProject.description',0,'project',NULL,NULL,NULL,4);
